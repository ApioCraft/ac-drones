...
public class DroneCompareCommand implements DroneCommand {
    ...
    public CompletableFuture<DroneCommandResult> execute(IDroneAccess drone) {
        ...
        return ItemStack.areEqual(selectedStack, comparingStack) ? CompletableFuture.completedFuture(DroneCommandResult.success()) : CompletableFuture.completedFuture(DroneCommandResult.failure());
    }
}
